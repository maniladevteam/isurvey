...
<div>
	...
	<div class="table-responsive">
		...
		<div id="add_space">
			<a href="javascript:void(0)" class="btn btn-info btn-danger btn-md" role="button" id="add_new_question_field">Add Question</a> <a
				href="javascript:void(0)" class="btn btn-info btn-danger btn-md" role="button" id="save_elements"
